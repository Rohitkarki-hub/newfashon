    ...
    <header className="fixed w-full z-10">
      <section>
        ...
        <div
          ...
          } lg:hidden flex flex-col absolute bg-SecpndaryColor text-black left-0 top-16 font-semibold text-2xl text-center pt-8 pb-4 gap-8 w-full h-fit transition-transform duration-300 `}
        >
          <Link
            to="home"
            spy={true}
